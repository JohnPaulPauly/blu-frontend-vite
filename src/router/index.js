...
import {DashboardView, AboutView, RegisterView, LoginView, AccessMapView, UserVerificationView, VerificationConfirmedView} from "@/views";
...
const routes = [
    ...
    { path: '/pathhistory', name: "pairdevice", component: PairDeviceView},
