...
<template>
  ...
  <!--size nav bar as sticky!-->
  <nav class="bg-white mb-8 dark:bg-gray-900 fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600 ">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      <a href="https://flowbite.com/" class="flex items-center space-x-3 rtl:space-x-reverse">
        <img :src="bluLogo" class="h-8" alt="Flowbite Logo">
        <span class="self-center text-2xl font-semibold whitespace-nowrap text-blu800">Bluetooth Low Energy</span>
      </a>
      ...
      <!--hamburger menu for options and links-->
